...
custom_css: |
  ...
  .page--pastoral-de-la-salud .pastoral-images {
    display: grid;
  ...
  .page--pastoral-de-la-salud .pastoral-images img {
    width: 100%;
    height: auto;
    margin: 0;
    border-radius: 8px;
...
### Enlaces a documentos públicos y webs sobre la Pastoral de la Salud
